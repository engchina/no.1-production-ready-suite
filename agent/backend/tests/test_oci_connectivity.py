...
from app.features.agent import router as settings_router
from app.features.agent.router import OciConfigTestResult
...
_SETTINGS = SimpleNamespace(oci_config_file="~/.oci/config", oci_config_profile="DEFAULT")
...
def _write_oci_files(
    ...
    *,
    ...
    monkeypatch.setattr(settings_router, "OCI_PRIVATE_KEY_FILE", str(key_file))
