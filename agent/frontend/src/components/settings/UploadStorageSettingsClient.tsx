  ...
  return (
    <div className="space-y-1.5">
      ...
      <input
        ...
        className={cn(
          "h-11 w-full rounded-md border bg-surface px-3 text-sm text-fg outline-none transition-colors placeholder:text-fg-muted focus-visible:border-focus-ring",
