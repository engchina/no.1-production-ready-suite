...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: APP_ROUTES.sqlToQuestion, labelKey: "nav.sqlToQuestion", icon: ArrowRightLeft, permission: MENU_PERMISSIONS.sqlToQuestion },
  ...
  },
  {
    ...
    items: [
      ...
      { href: APP_ROUTES.annotationManagement, labelKey: "nav.annotationManagement", icon: BookOpen, permission: MENU_PERMISSIONS.annotationManagement },
      { href: APP_ROUTES.glossaryRules, labelKey: "nav.glossaryRules", icon: BookOpen, permission: MENU_PERMISSIONS.glossaryRules },
      { href: APP_ROUTES.globalRules, labelKey: "nav.globalRules", icon: Layers3, permission: MENU_PERMISSIONS.globalRules },
      { href: APP_ROUTES.sampleData, labelKey: "nav.sampleData", icon: Database, permission: MENU_PERMISSIONS.sampleData },
    ],
  },
  {
    ...
    items: [
      ...
      { href: APP_ROUTES.feedbackManagement, labelKey: "nav.feedbackManagement", icon: MessageSquareText, permission: MENU_PERMISSIONS.feedbackManagement },
