...
def oracle_schema_migration_sections() -> list[OracleSchemaSection]:
    ...
    return [
        ...
        OracleSchemaSection(
            name="20260630_002_default_business_view",
            table_name="rag_business_views",
            sql=_default_business_view_migration_sql(),
        ),
        OracleSchemaSection(
...
def _default_business_view_migration_sql() -> str:
    """tenant ごとの DEFAULT 業務ビューを補完し、参照 KB と有効状態を固定する。"""
    return """
