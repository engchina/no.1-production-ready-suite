...
async function mockDocumentUpload(page: Page, onUpload: (body: string) => void) {
    ...
    await route.fulfill({
      json: {
        data: {
          ...
          source_profile: uploadSourceProfile(),
          ingestion_started: autoIngest,
          ingestion_job: autoIngest ? ingestionJob("job-upload", "doc-upload") : null,
        },
        error_messages: [],
        warning_messages: [],
      },
...
async function mockDocumentDetail(page: Page, documentId: string, fileName: string) {
