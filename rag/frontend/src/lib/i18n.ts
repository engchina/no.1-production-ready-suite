...
export const ja = {
  ...
  "flow.preview.preparedUnavailable": "処理後ファイルがありません。ファイル準備から再処理してください。",
  ...
  "flow.buildConfig.title": "ナレッジベース別の構築設定",
  "flow.buildConfig.summary": "{knowledgeBases} KB・{configurations}種類",
  "flow.buildConfig.groups": "構築設定グループ",
  ...
  "flow.buildConfig.empty": "所属ナレッジベースの構築設定がありません。",
  "flow.buildConfig.preprocess": "ファイル準備",
  "flow.buildConfig.parser": "文書解析",
  "flow.buildConfig.chunking": "文書分割",
  "flow.buildConfig.chunkingValue": "{strategy}・サイズ {size}・重複 {overlap}",
  "flow.buildConfig.indexBuild": "索引構築",
  "flow.buildConfig.autoAdvance": "自動進行",
  "flow.buildConfig.shared": "共有",
  "flow.buildConfig.reviewTarget": "確認対象",
  "flow.buildConfig.state.planned": "適用予定",
  "flow.buildConfig.state.building": "構築中",
  "flow.buildConfig.state.serving": "配信中",
  "flow.buildConfig.state.updateRequired": "更新が必要",
  "flow.buildConfig.state.error": "エラー",
  "flow.buildConfig.counts": "{chunks} Chunk・{vectors} Vector",
  "flow.buildConfig.servingCount": "{serving}/{total} KB に配信",
  "flow.buildConfig.index.field": "項目 {state}",
  "flow.buildConfig.index.asset": "図表 {state}",
  "flow.buildConfig.index.navigation": "ナビ {state}",
  "flow.buildConfig.auto.parse": "解析 {state}",
  "flow.buildConfig.auto.chunk": "分割 {state}",
  "flow.buildConfig.auto.index": "索引 {state}",
  "flow.buildConfig.auto.enabled": "自動",
  "flow.buildConfig.auto.disabled": "手動",
  "flow.buildConfig.layer.metadata": "項目・画像",
  "flow.buildConfig.layer.graph": "関係情報",
  "flow.buildConfig.layer.navigation": "ナビ",
  ...
  "flow.error.fallback":
    "取込に失敗しました。時間をおいて再処理し、解消しない場合は「取込・診断の詳細」を確認してください。",
