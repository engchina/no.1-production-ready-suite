...
export const ja = {
  ...
  "flow.error.fallback":
    "文書処理に失敗しました。時間をおいて再実行し、解消しない場合は「取込・診断の詳細」を確認してください。",
  "flow.phase.started.preprocess": "ファイル準備を開始しました。完了まで状態を更新します。",
  "flow.phase.started.extract": "解析（抽出）を開始しました。完了まで状態を更新します。",
  ...
  "flow.phase.running.extract": "解析（抽出）を実行しています。完了まで状態を更新します。",
