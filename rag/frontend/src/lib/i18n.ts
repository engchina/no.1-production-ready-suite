...
export const ja = {
  ...
  // A 型のエディタと B 型の分割ペイン（platform ux-contracts/page-archetypes.md）
  ...
  "split.equal": "左右 1:1",
  "split.leftWide": "一覧を広く表示",
  "split.rightWide": "詳細を広く表示",
  ...
  "businessViews.runtime.editNamed": "{name} を編集",
  "businessViews.runtime.deleteConfirm.title": "この用語・ルールを削除しますか？",
  "businessViews.runtime.deleteConfirm.description":
    "「{name}」を削除します。回答で使われなくなり、元に戻せません。",
  ...
  "businessViews.col.name": "名前",
  "businessViews.col.status": "状態",
  "businessViews.col.knowledgeBases": "参照 KB",
  "businessViews.col.updated": "更新日時",
  "businessViews.col.actions": "操作",
  ...
  "search.evaluation.description":
    "期待する回答（標準回答）を入れると、LLM がこの回答を 4 つの観点で採点します（各 5 点・合計 20 点、16 点以上で合格）。LLM を複数回呼ぶため、時間がかかります。",
  ...
  "search.evaluation.outcome.notCompleted": "評価できませんでした",
  "search.evaluation.total": "合計 {score} / {max} 点（合格は {threshold} 点以上）",
  "search.evaluation.evaluatedAt": "評価日時: {value}",
  "search.evaluation.axis": "観点",
  "search.evaluation.score": "点",
  "search.evaluation.reason": "理由",
  "search.evaluation.axis.accuracy": "正確性",
  "search.evaluation.axis.coverage": "網羅性",
  "search.evaluation.axis.evidence_consistency": "根拠との整合性",
  "search.evaluation.axis.generation_quality": "回答の品質",
  "search.evaluation.externalData": "回答の確定に外部のデータ確認が必要: {items}",
  "search.evaluation.coverage": "標準回答の項目への対応（{count}）",
  "search.evaluation.coverage.addressed": "対応",
  "search.evaluation.coverage.partial": "一部対応",
  "search.evaluation.coverage.missing": "未対応",
  "search.evaluation.claims": "回答の主張の監査（{count}）",
  "search.evaluation.claim.supported": "根拠で確認できる",
  "search.evaluation.claim.unsupported": "根拠で確認できない",
  "search.evaluation.claim.contradicted": "根拠と矛盾する",
  "search.evaluation.claim.data_confirmation": "実データの確認が必要",
  "search.evaluation.claim.citation_error": "評価の引用を確認できない",
  "search.evaluation.claim.unassessed": "監査されていない",
  ...
  "search.history.objectName": "保存された回答",
  ...
  "settings.docragPrompts.placeholders": "必須の placeholder: {names}。欠けていると保存できません。",
  "settings.docragPrompts.save": "プロンプトを保存",
  "settings.docragPrompts.saved": "プロンプトを保存しました。",
  "settings.docragPrompts.reset": "既定に戻す",
  "settings.docragPrompts.resetDone": "既定のプロンプトに戻しました。",
  "settings.docragPrompts.resetTitle": "既定のプロンプトに戻しますか？",
  "settings.docragPrompts.resetDescription": "編集した内容を削除し、コードの既定値を使います。元に戻せません。",
  "settings.docragPrompts.saveError": "プロンプトを保存できませんでした。",
  "settings.docragPrompts.loadError": "プロンプトを読み込めませんでした。",
  "settings.docragPrompts.stages.title": "回答フローの各段のプロンプト（読み取り専用）",
  "settings.docragPrompts.stages.description":
    "DocRAG の回答フローが各段で使う指示です。コードで管理しているため、ここでは確認だけできます。",
  ...
  "settings.docragPrompts.stage.evaluation": "6. 標準回答による評価",
  "settings.docragPrompts.part.system": "system プロンプト",
  "settings.docragPrompts.part.template": "入力テンプレート",
  "settings.docragPrompts.part.scope": "評価範囲の固定",
  "settings.queryHistory.title": "質問履歴",
  "settings.queryHistory.description":
    "回答に成功した質問を業務ビューごとに保存し、よく聞かれている質問を RAG 検索の入力欄の下に候補として出します。質問の本文を保存するため、既定では無効です。",
  "settings.queryHistory.enabled": "質問を保存して候補に使う",
  "settings.queryHistory.enabledHint":
    "安全チェックでマスクした後の質問を保存します。無効にしても保存済みの履歴は保存期間まで残ります。",
  "settings.queryHistory.retention": "履歴の保存期間",
  "settings.queryHistory.minCount": "候補にする最小回数",
  "settings.queryHistory.minCountHint": "同じ質問がこの回数以上聞かれたときだけ候補にします。",
  ...
  "feedback.reason.missing_knowledge": "ナレッジ不足（必要な情報が登録文書にない）",
  "feedback.reason.outdated_source": "情報が古い（出典が現在の仕様・運用と違う）",
  ...
  "feedback.detail.emptyTitle": "フィードバックを選んでください",
  "feedback.detail.emptyHint": "一覧の行を選ぶと、内容・根拠・実行情報をここに表示します。",
  ...
  "feedback.detail.correctedAnswer": "修正した回答",
  "feedback.detail.noCorrectedAnswer": "修正した回答はありません。",
  "feedback.promote.faq": "Approved FAQ に登録",
  "feedback.promote.faqConfirmTitle": "業務ビューの Approved FAQ に登録しますか？",
  "feedback.promote.faqConfirmDescription":
    "「役に立った」回答はそのまま、それ以外は修正した回答を FAQ の回答として登録します。同じ質問の FAQ があれば置き換えます。",
  "feedback.promote.faqDone": "Approved FAQ に登録しました: {question}",
  "feedback.promote.evaluation": "品質評価のケースに追加",
  "feedback.promote.evaluationDone": "品質評価のケースに追加しました。評価を実行して確認してください。",
  "feedback.promote.evaluationInvalidRequest":
    "品質評価の要求 JSON が編集途中で読み取れないため、追加できません。品質評価の入力を直してから再試行してください。",
  "feedback.promote.error": "操作に失敗しました。時間をおいて再試行してください。",
