...
export const ja = {
  ...
  "settings.oci.configTest.title": "OCI 接続テスト",
  "settings.oci.configTest.checking": "OCI への接続を確認中…",
  "settings.oci.configTest.success": "成功",
  "settings.oci.configTest.failed": "失敗",
  ...
  "settings.oci.configTest.troubleshooting": "確認ポイント",
  "settings.oci.configTest.elapsed": "所要時間: {ms} ms",
  "settings.oci.env.title": ".env プレビュー",
  "settings.oci.env.description":
    "保存時にサーバー側 .env へ反映される OCI 共通設定です。",
  "settings.oci.hint":
    "保存した設定は、AI分析やObject Storage接続に反映されます。接続テストはサーバーに保存済みの設定で OCI へ認証付きリクエストを送り、疎通を確認します。変更後は先に保存してください。",
