...
export const ja = {
  ...
  "settings.services.group.preprocess": "前処理サービス",
  "settings.services.group.parserCpu": "Parser サービス(CPU)",
  "settings.services.group.parserGpu": "Parser サービス(GPU)",
  "settings.services.group.pipeline": "RAG パイプライン ステージ",
  ...
  "settings.services.pipelineNote": "各ステージのプラグイン。既定は backend in-process で、サービス有効化時のみ HTTP 委譲(未達時は in-process へ縮退)。",
