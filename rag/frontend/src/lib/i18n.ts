...
export const ja = {
  ...
  "settings.parserAdapters.adapters.title": "解析方式の稼働状況",
  "settings.parserAdapters.adapters.description":
    "有効化設定、導入状況、選択状態を分けて表示します。",
  ...
  "settings.parserAdapters.contract.packageEvidence": "パッケージ",
  "settings.parserAdapters.contract.parserEvidence": "解析器",
  "settings.parserAdapters.contract.fixtureEvidence": "検証データ",
  "settings.parserAdapters.contract.noPackageEvidence": "パッケージ証跡なし",
  ...
  "settings.parserAdapters.contract.reason.adapter_distribution_name_missing":
    "distribution 証跡なし",
  "settings.parserAdapters.contract.reason.adapter_missing": "パッケージ未導入",
  ...
  "settings.parserAdapters.routes.title": "原本種別ごとの実行順",
  "settings.parserAdapters.routes.description":
    "原本種別ごとの候補順、実行対象、フォールバックを現在の設定の証跡として確認します。",
  "settings.parserAdapters.routes.required": "対象の原本種別",
  "settings.parserAdapters.routes.covered": "実行順設定済み",
  "settings.parserAdapters.routes.missing": "未定義",
  "settings.parserAdapters.routes.empty": "原本種別ごとの実行順証跡はまだありません。",
  ...
  "settings.parserAdapters.routes.activeOrder": "適用順",
  "settings.parserAdapters.routes.selectedBackend": "選択エンジン",
  "settings.parserAdapters.routes.reason": "理由",
  "settings.parserAdapters.routes.noAdapter": "外部解析方式なし",
  ...
  "settings.parserAdapters.flag": "有効化",
  "settings.parserAdapters.package": "パッケージ",
  "settings.parserAdapters.role": "役割",
  ...
  "settings.parserAdapters.flagToggleAria": "{adapter} 解析方式の有効化設定",
  ...
  "settings.parserAdapters.status.active": "有効",
  "settings.parserAdapters.status.available": "利用可",
  "settings.parserAdapters.status.disabled": "無効",
  "settings.parserAdapters.status.ignored": "選択外",
  "settings.parserAdapters.status.missing": "未導入",
  "settings.parserAdapters.warning.adapter_feature_flag_disabled": "有効化設定が無効",
  "settings.parserAdapters.warning.adapter_package_missing": "パッケージ未導入",
  ...
  "settings.services.optionalStoppedHint.inProcess":
    "停止中です。既定検索は backend 内処理で継続します。遠隔委譲を有効化した場合のみ起動してください。",
  ...
  "settings.services.logs.source.uv": "uv ログ / 最新 {lines} 行",
  ...
  "flow.indexSummary.chunkSet": "Chunk set",
  ...
  "action.enqueueDuplicateIngestion": "重複を無視して取込",
  "action.queueing": "投入中…",
