...
from docrag.parsing.rendering import get_pdf_page_count, pdf_text_lines_in_bbox, render_pdf_pages
...
class PdfiumRenderingTests(unittest.TestCase):
    ...
    def test_get_pdf_page_count_closes_document(self):
        with patch("docrag.parsing.rendering._import_pdfium", return_value=self.pdfium):
