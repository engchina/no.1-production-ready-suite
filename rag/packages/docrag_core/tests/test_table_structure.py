...
from docrag.parsing.table_structure import parse_html_table_structure, table_row_group_text, table_row_groups
...
def test_rowspan_value_cells_are_inherited_by_following_rows():
    ...
    from docrag.parsing.table_structure import parse_html_table_structure, table_row_groups
...
def test_misplaced_cell_text_is_moved_back_from_the_neighbor_row():
    ...
    from docrag.parsing.table_structure import misplaced_cell_repairs
...
def test_row_groups_match_the_full_text_reference_on_a_large_table():
    ...
    from docrag.parsing.table_structure import table_row_group_text, table_row_groups
