...
from app.docrag.vision_llm import describe_picture, _image_retrieval_template, _render_prompt, VISION_SYSTEM_PROMPT
from app.docrag.checkpoints import CheckpointError, checkpoint_lock, file_digest, digest_json
from app.docrag.rendering import pdf_text_lines_in_bbox
from app.docrag.vision_checkpoints import VisionCheckpoints
from app.docrag.layout import LayoutRecord, PageImage
from app.docrag.settings import Settings, get_vision_provider
    ...
    *,
    ...
    def pending_targets():
        ...
        if pdf_path is not None:
            from app.docrag.table_vision import missing_table_image_regions
