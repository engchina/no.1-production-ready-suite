...
from app.docrag.docling_adapter import (
    DoclingAdapter,
...
class DoclingAdapterTests(unittest.TestCase):
    ...
    def test_table_text_that_no_cell_received_is_kept_as_a_supplement_record(self):
        ...
        with patch("app.docrag.docling_adapter.pdf_text_lines_in_bbox", return_value=native_lines) as lines:
    ...
    def test_table_cell_text_moved_to_the_neighbor_row_is_repaired_before_building_html(self):
        ...
        with patch("app.docrag.docling_adapter.pdf_text_lines_in_bbox", return_value=lines):
    ...
    def test_table_supplement_is_skipped_when_cells_are_complete_or_the_text_layer_is_unavailable(self):
        ...
        with patch("app.docrag.docling_adapter.pdf_text_lines_in_bbox", side_effect=RuntimeError("no text layer")):
